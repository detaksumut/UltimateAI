...
export default function ChatSimulator() {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a] text-white font-sans overflow-hidden">
      ...
      {/* LEFT SIDEBAR */}
      <div className="w-[260px] bg-[#111111] border-r border-neutral-800 flex flex-col shrink-0">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-2 space-y-6 flex flex-col">
          ...
          <div className="space-y-1 text-sm font-medium text-neutral-400">
            ...
            <div className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-[#111111] hover:text-white cursor-pointer transition-colors">
          ...
          {/* Section 2 */}
          <div className="space-y-1 text-sm font-medium text-neutral-400 flex-1">
            <div className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-[#111111] hover:text-white cursor-pointer transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#0a0a0a]">
        ...
        {/* Topbar */}
        <div className="h-16 border-b border-neutral-800 bg-[#111111] flex items-center justify-end px-6 gap-4">
          <Bell className="w-5 h-5 text-neutral-400 cursor-pointer hover:text-white" />
        ...
        <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full p-8 overflow-hidden">
          ...
          {/* Pipeline Stepper */}
          <div className="bg-[#111111] border border-neutral-800 rounded-2xl p-6 mb-8 flex items-center justify-between shrink-0 relative shadow-sm">
            {/* Connecting line */}
            ...
            {pipelineSteps.map((step, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center gap-2 bg-[#111111] px-2">
                  ...
                  <span className={`text-[11px] font-semibold uppercase tracking-wider ${status === 'active' ? 'text-indigo-400' : 'text-neutral-400'}`}>
                    {step.id}
                  </span>
                </div>
              );
          ...
          <div className="flex-1 overflow-y-auto space-y-6 pr-4">
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center opacity-70">
                ...
                <p className="text-neutral-400">Jelaskan apa yang ingin Anda buat, UltimateAI akan mewujudkannya.</p>
              </div>
            )}
            ...
            {messages.map((msg, idx) => (
              <div key={idx} className={`flex gap-4 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                ...
                <div className={`max-w-[80%] rounded-2xl p-5 shadow-sm ${
                  msg.role === 'user' 
                    ? 'bg-[#111111] border border-neutral-800 text-white rounded-tr-none'
                  ...
                  {msg.role === 'user' ? (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-2 pt-2">
                          {msg.options.map((opt, i) => (
                            <button 
                              ...
                              className="px-4 py-3 bg-[#111111] border border-indigo-500/20 text-indigo-400 rounded-xl text-sm font-semibold hover:bg-indigo-500/10 hover:border-indigo-200 transition text-left shadow-sm disabled:opacity-50"
                            >
                              {opt}
                            </button>
                          ))}
                      ...
                      {msg.type === 'proposal' && msg.proposal && (
                        <div className="mt-4 bg-[#0a0a0a] border border-neutral-800 rounded-xl overflow-hidden">
                          ...
                          <div className="p-4 space-y-4 text-sm">
                            ...
                            <div>
                              <h4 className="text-neutral-400 mb-1 text-[10px] uppercase tracking-wider font-bold">Apa yang akan dibuat</h4>
                            ...
                            <div>
                              <h4 className="text-neutral-400 mb-1 text-[10px] uppercase tracking-wider font-bold">Tujuan</h4>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <h4 className="text-neutral-400 mb-2 text-[10px] uppercase tracking-wider font-bold">Yang akan dicatat</h4>
                              ...
                              <div>
                                <h4 className="text-neutral-400 mb-2 text-[10px] uppercase tracking-wider font-bold">Laporan</h4>
                                <ul className="space-y-1.5 text-[13px]">
                            ...
                            <div>
                              <h4 className="text-neutral-400 mb-2 text-[10px] uppercase tracking-wider font-bold">Fitur Kunci</h4>
                              <ul className="space-y-2">
                                {msg.proposal.features?.map((f, i) => (
                                  <li key={i} className="flex items-start gap-2 bg-neutral-800/50 p-2 rounded-lg border border-neutral-800">
                                    ...
                                    <div>
                                      ...
                                      {f.reason && <div className="text-[11px] text-neutral-400 leading-tight mt-0.5">{f.reason}</div>}
                                    </div>
                                  </li>
                                ))}
                              </ul>
                            ...
                            <div className="bg-indigo-950/20 p-4 border-t border-indigo-500/20">
                                ...
                                {msg.proposal.recommendations.map((rec, i) => {
                                  ...
                                  return (
                                    <div 
                                      ...
                                      className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${isSelected ? 'bg-indigo-600/20 border-indigo-500' : 'bg-black border-neutral-800 hover:border-neutral-600'}`}
                                    >
                                      ...
                                      <div>
                                        ...
                                        {rec.reason && <div className="text-[11px] text-neutral-400 leading-tight mt-0.5">{rec.reason}</div>}
                                      </div>
                                    </div>
                                  );
                                })}
                              ...
                              <div className="flex gap-2">
                                ...
                                <button 
                                  ...
                                  className="text-[11px] font-semibold bg-neutral-800 text-neutral-400 px-3 py-1.5 rounded hover:bg-neutral-700 hover:text-white transition"
                                >
                                  Pilih Manual
                                </button>
                              </div>
                          ...
                          {idx === messages.length - 1 && !isProcessing && !revisionMode && (
                            <div className="bg-neutral-900 p-4 border-t border-neutral-800 flex gap-3">
                              <button 
                                onClick={() => {
                              ...
                              <button 
                                ...
                                className="flex-1 bg-neutral-800 hover:bg-neutral-700 text-white border border-neutral-700 py-2.5 rounded-lg text-sm font-semibold transition flex items-center justify-center gap-2"
                              >
                          ...
                          {idx === messages.length - 1 && revisionMode && (
                            <div className="bg-neutral-900 p-4 border-t border-neutral-800 border-l-2 border-l-indigo-500">
                              ...
                              {!revisionType ? (
                                <div className="grid grid-cols-2 gap-2">
                                  {['Tambah Data', 'Kurangi Data', 'Tambah Fitur', 'Ubah Laporan', 'Lainnya'].map(opt => (
                                    <button 
                                      ...
                                      className="px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-xs font-medium text-neutral-300 hover:bg-neutral-700 hover:text-white transition text-left flex items-center"
                                    >
                                ...
                                <div className="space-y-3">
                                  ...
                                  <input 
                                    ...
                                    className="w-full bg-black border border-neutral-700 rounded-lg py-2.5 px-3 text-sm text-white focus:outline-none focus:border-indigo-500 transition-colors"
                                    onKeyDown={(e) => {
          ...
          <div className="mt-6 pt-4">
            <form onSubmit={handleSubmit} className="relative shadow-sm rounded-2xl bg-[#111111] border border-neutral-800 flex items-center p-2">
              <button type="button" className="p-3 text-neutral-400 hover:text-neutral-400">
      ...
      <div className="w-[400px] bg-[#111111] border-l border-neutral-800 flex flex-col shrink-0 overflow-y-auto">
        ...
        <div className="p-6 pb-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-neutral-400 bg-[#111111] border border-neutral-800 px-2 py-1 rounded-md">iPhone 15</span>
          ...
          <div className="relative mx-auto w-[340px] h-[680px] bg-black rounded-[40px] shadow-2xl border-[10px] border-neutral-900 shrink-0 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 bg-[#111111] relative">
              ...
              {simulatorHtml ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-[#111111] text-neutral-400 p-6 text-center">
