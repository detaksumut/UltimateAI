      ...
      if (!isInternalAgentCall && userPrompt && typeof userPrompt === 'string' && userPrompt.trim().length > 0) {
        try {
          ...
          if (actionRequired) {
            ...
            // DIRECT SLIDE VISUAL GENERATION - "slide N" triggers auto-visual (CEK PERTAMA!)
            ...
            if (deterministicDecision.intent === 'PRESENTATION_REQUEST') {
              try {
                ...
                const draftResult = await presentationGeneratorInstance.generateDraft(presentationIntent, sessionId);
